...
for(id in master_batters$mlb_id){
  ...
  minor_league_hitting = player %>%
    html_nodes(xpath = '//*[@id="hittingStandardMiLB"]/table') %>%
    html_table()
  
  minor_league_fielding = player %>%
    html_nodes(xpath = '//*[@id="fieldingStandardMiLB"]/table') %>%
    html_table()
  ...
  game_log_batting
  minor_league_hitting
  minor_league_fielding
...
minor_pitching_statistics = player %>%
  html_nodes(xpath = '//*[@id="pitchingStandardMiLB"]/table') %>%
  html_table()
...
# Web-Scrape test with Bryce Harper
player = read_html(paste0("https://baseballsavant.mlb.com/savant-player/", 547180))
...
# Web-Scrape Test with Dallas Keuchel
player = read_html(paste0("https://baseballsavant.mlb.com/savant-player/", 572971))
